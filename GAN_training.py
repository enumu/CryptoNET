...
def Adversarial_training(Alice, Eve, Bob, FFN, train_data_loader , valid_data_loader, batch_size, FFN_optim, Eve_optim , GAN_epoch, Alice_epoch , Eve_epoch):
    ...
    for k in range(Alice_epoch):
      ...
      for i,train_data in enumerate(train_data_loader):
        ...
        if i%100 == 0:
          ...
          print("Eve's p1 Loss is" , criterion(image,E_image) )
        loss.backward()
        FFN_optim.step()
